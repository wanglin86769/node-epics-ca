...
const MonitorCallback = koffi.proto('MonitorCallback', 'void', [event_args_t]);

const GetCallback = koffi.proto('GetCallback', 'void', [event_args_t]);
const PutCallback = koffi.proto('PutCallback', 'void', [event_args_t]);

const connection_args_t = koffi.struct('connection_args_t', {
    chid: chanId,
    op: 'long'
  });
const ConnectionCallback = koffi.proto('ConnectionCallback', 'void', [connection_args_t]);
...
const ca_create_channel = libca.func('ca_create_channel', 'int', ['string',koffi.pointer(ConnectionCallback),'void *','int',koffi.out(koffi.pointer(chanId))]);
...
const ca_create_subscription = libca.func('ca_create_subscription', 'int', ['int','ulong',chanId,'long',koffi.pointer(MonitorCallback),'void *',koffi.out(koffi.pointer(evid))]);
...
class Channel extends EventEmitter {
    ...
    get(asString = false) {
        return new Promise((resolve, reject) => {
            ...
            /** 
             * ca_pend_event() is not needed in the Node.js single-threaded, event-driven environment.
             * It is a constant delay and affects the performance.
             * 
             */
